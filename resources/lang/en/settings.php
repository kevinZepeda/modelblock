...
return [
    ...
    'general' => [
        ...
        'layout_color' => [
            'title' => 'System Color',
            'explanation' => 'The <b>System Layout Color</b> will be reflected immediately.',
            'explanation_text' => 'The <b>Text Layout Color</b> will be reflected immediately'
        ],
        'system_logo' => [
            'title' => 'System Logo',
            'explanation' => 'If it\'s set it will be displayed instead of the System Label.',
            'click_to_edit' => 'Click on edit to preview',
            'drop_here' => 'Drop your Logo here on click to upload',
            'allowed_files' => '(max expected dimensions are <b>200 x 52</b> pixels and only <b>jpg</b>, <b>jpeg</b> and <b>png</b> file types are allowed) '
        ]
    ],
    'manage_columns' => [
    ...
    'manage_departments' => [
        ...
        'explanation' => '<strong>Any change </strong> will be immediately reflected to your account.',
        'message' => 'Are you sure you would like to delete the department ?',
        'input' => [
    ...
    'new_department' => [
        ...
        'explanation' => 'You can set for each user a Department',
        'input' => [
            'department_name' => 'Department Name',
        ]
    ],
