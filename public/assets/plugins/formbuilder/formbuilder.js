...
(function() {
  Formbuilder.registerField('color', {
    order: 50,
    view: "<div class='input-line'>\n <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/> <input class='color-box'/></div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-tint\"></span></span> Color Palete"
  });
