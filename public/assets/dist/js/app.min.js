...
$(document).ready(function(){
  $(".editor-icon").hover(function(){
    $(this).find('.item').fadeTo( "fast" , 0.2, function() {
      $(this).parent().find('.editor-icon-set').fadeIn('fast');
    });
  },function(){
    $(this).find('.item').fadeTo( "fast" , 1, function() {
      $(this).parent().find('.editor-icon-set').hide();
    }); 
  });
